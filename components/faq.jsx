        ...
        {faqdata.map((item, index) => (
          <div key={item.question} className="mb-5">
            <Disclosure>
              {({ open }) => (
                <>
                  <Disclosure.Button className="flex bg-green items-center font-primary justify-between w-full px-4 py-4 text-lg text-left text-white rounded-lg bg-gray-50 hover:bg-[#1b4023] focus:outline-none focus-visible:ring focus-visible:ring-indigo-100 focus-visible:ring-opacity-75">
