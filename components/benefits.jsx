  ...
  if (React.isValidElement(props.icon)) {
    return (
      <div className="flex items-start mt-8 space-x-3">
        ...
        <div>
          <h4 className="text-xl font-primary text-gray-800">{props.title}</h4>
          <p className="mt-1 font-primary text-gray-500">{props.children}</p>
        </div>
      </div>
    );
    ...
    return (
      <div className="flex items-start mt-8 space-x-3">
        <div className="flex items-center justify-center flex-shrink-0 mt-1  rounded-md ">
          <Image
